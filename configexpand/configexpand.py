...
def main():
    ...
    print(
        time.strftime(
            '[%d/%m %H:%M:%S]',
            time.localtime()) +
        ' Config generated. Writing to config.conf ...')
